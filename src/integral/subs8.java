...
public class subs8 {
    public static void main(String[] args){
        try {
            FileWriter soal = new FileWriter("int sub8.txt");
            FileWriter kj = new FileWriter("kjsub8.txt");
            int i = 1;
            while(i<=1000) {
                ...
                if (p2 > 1 && p1 != p2) {
                    ...
                    if(p2>2) {
                        ...
                        if(p1 == 1) {
                            soal.write("\\item $\\displaystyle \\int \\left(" + uya + "\\right)\\sqrt[" + p2 + "]{" + u + "}\\, \\, dx = \\cdots $");
                        } else {
                            soal.write("\\item $\\displaystyle \\int \\left(" + uya + "\\right)\\sqrt[" + p2 + "]{(" + u + ")^{" + p1 + "}}\\, \\, dx = \\cdots $");
                        }
                    } else {
                        ...
                        if(p1 == 1) {
                            soal.write("\\item $\\displaystyle \\int \\left(" + uya + "\\right)\\sqrt{" + u + "}\\, \\, dx =\\cdots $");
                        } else {
                            soal.write("\\item $\\displaystyle \\int \\left(" + uya + "\\right)\\sqrt{(" + u + ")^{" + p1 + "}}\\, \\, dx = \\cdots $");
                        }
                    }
